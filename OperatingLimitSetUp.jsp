...
<%@ page import="com.ibank.ibanking.businessadministration.bo.OperatingLimitSetUpBO"%>
<html>
<head>
...
<script language="javascript" type="text/javascript">
	function   setBodyProperty() {
		...
		var OperationType= document.operatingLimitSetUpForm.operationType.value;
 ...
 $(document).ready(
	...
	function doMainMenu(f){
		f.action="/ibanking/cancelOperatingLimitSetUp.do";
		f.submit();
	}
	function doLogOut(){
		var f = document.operatingLimitSetUpForm;	
			f.action="/ibanking/logOutIBanking.do";
			f.submit();		
	}	
	function doUserDetails(f){
		f.action="/ibanking/showDataOperatingLimitSetUp.do?";
		f.submit();	
	}
	
	function doExecute(f){
		if(document.operatingLimitSetUpForm.editFlag.value == "Y"){
			document.operatingLimitSetUpForm.operationMode.value="M";
			f.action="/ibanking/executeOperatingLimitSetUp.do";
			f.submit();
		}
		else{
			document.operatingLimitSetUpForm.operationMode.value="A";
			f.action="/ibanking/executeOperatingLimitSetUp.do";
			f.submit();
		}
	}
	...
	function doClear(f){
		f.action="/ibanking/operatingLimitSetUp.do";
		f.submit();
	}	
	
	
	function doEdit(f,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13){				
		document.operatingLimitSetUpForm.operationMode.value = "M";
		document.operatingLimitSetUpForm.editFlag.value = "Y";
		document.operatingLimitSetUpForm.serialNo.value=v1;
		document.operatingLimitSetUpForm.sanctionID.value=v2;
		document.operatingLimitSetUpForm.sanctionDate.value=v3;
		document.operatingLimitSetUpForm.subType.value=v4;
		document.operatingLimitSetUpForm.limitType.value=v5;
		document.operatingLimitSetUpForm.transactionFrequency.value=v6;
		document.operatingLimitSetUpForm.lowLimit.value=v7;
		document.operatingLimitSetUpForm.highLimit.value=v8;
		document.operatingLimitSetUpForm.dailyTranLimit.value=v9;
		document.operatingLimitSetUpForm.fromDate.value=v10;
		document.operatingLimitSetUpForm.toDate.value=v11;
		document.operatingLimitSetUpForm.remarks.value=v12;		
		document.operatingLimitSetUpForm.status.value=v13;		
...
<html:form action="/operatingLimitSetUp" enctype="multipart/form-data" style="margin: 0">
                  ...
                  <td width="92%" class="myBankHeader"><table width="100%" border="0" cellspacing="3" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td align="center" valign="top"><font class="usr-6">System Admin</font><font class="usr-1">
                          ...
                          </font>Operating Limit Set Up</td>
                        <td colspan="2" align="right" valign="top"><a href="#" onClick="doMainMenu(operatingLimitSetUpForm)"><font class="usr-5">
                          <bean:message key="label.mainMenu"/>
                          </font></a> <font class="usr-1">
                          <bean:message key="label.|"/>
                          </font> <a href="#"  onClick="doLogOut(operatingLimitSetUpForm)" ><font class="usr-5">
                ...
                <table width="100%" style="width: 100%;border:0">
                  <tr>
                   ...
                   <tr class="spaceUnder">
                    ...
                    <td>&nbsp;</td>
                    <td onKeyPress="doUserDetails(operatingLimitSetUpForm)"><html:select property="operationType"  style="width:210px;" onchange="doUserDetails(operatingLimitSetUpForm)">
                  ...
                  <tr class="spaceUnder">
                    <td align="right" class="lbl-n">From Date</td>
                    <td>&nbsp;</td>
                    <td><html:text property="fromDate" styleClass="txt-n"  style="width:210px;"  styleId="datepicker1"/></td>
                  </tr>
                  <tr class="spaceUnder">
                  ...
                  <tr>
                    ...
                    <td valign="top" class="lbl-n" align="left"><div style="width:210px;text-align:center;vertical-align:middle">
                        <p>                  
                          <input type="button" value="Submit" onClick="doExecute(operatingLimitSetUpForm)"   style="width:67px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/>
                          <input type="button" value="Clear"  onClick="doClear(operatingLimitSetUpForm)" style="width:67px;text-align:center;color:#0000ff; font-size : 10pt;font-weight:bold"/>
                        </p>
            ...
            <td width="67%" valign="top"><div id="tableContainer" class="tableContainer" style="height:400px;">
                ...
                <table style="width: 100%" border="1" align="center" cellpadding="3" cellspacing="3" id="table_box" class="maintb">
                  <tr bgcolor="#99CCCC">
                    ...
                    <th valign="middle" width="8%" class="lbl-b-08" align="center">Low Limit</th>
                     <th valign="middle" width="8%" class="lbl-b-08" align="center">High Limit</th>
                    <th valign="middle" width="8%" class="lbl-b-08" align="center">Daily Tran Limit</th>
                    <th valign="middle" width="9%" class="lbl-b-08" align="center">From Date</th>
                    <th valign="middle" width="9%" class="lbl-b-08" align="center">To Date</th>
                  ...
                  <%
					...
					if(session.getAttribute("oOperatingLimitSetUpBO")!=null){
					OperatingLimitSetUpBO mainBO=(OperatingLimitSetUpBO)session.getAttribute("oOperatingLimitSetUpBO");
					...
					OperatingLimitSetUpBO bo=(OperatingLimitSetUpBO)aDestinationBankList.get(i);
					...
					String sFromDate = bo.getFromDate();
					String sToDate = bo.getToDate();
                  ...
                  <tr bgcolor="#99CCFF">
                    ...
                    <td align="center" valign="top" class="lbl-08"><%=sFromDate%></td>
                    <td align="center" valign="top" class="lbl-08"><%=sToDate%></td>
                    <td align="left" valign="top" class="lbl-08"><%=sRemarks%></td>
                    <td align="center" valign="top" class="lbl-08"><%=sStatus%></td>
                    <td colspan="6" align="center" valign="top"><a href="#" onClick="doEdit(operatingLimitSetUpForm,'<%=sSerialNo%>','<%=sSanctionID%>','<%=sSanctionDate%>','<%=sSubType%>',
                    '<%=sLimitType%>','<%=sTransactionFrequency%>','<%=sLowLimit%>','<%=sHighLimit%>','<%=sDailyTranLimit%>','<%=sFromDate%>','<%=sToDate%>','<%=sRemarks%>','<%=sStatusFlag%>')"> <font class="link-b-08"><%=sEdit%></font></a></td>
                  </tr>
                  <%         
			  }
		      }
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="#" onClick="doExecute(operatingLimitSetUpForm)" class="btn btn-success success">Submit</a> </div>
        </div>
      </div>
    </div>
